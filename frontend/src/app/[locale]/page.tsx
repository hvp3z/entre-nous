  ...
  const themes = [
    {
      ...
      borderColor: 'border-bars-200',
      iconColor: 'text-bars-600',
      btnClass: 'btn-bars',
    },
    {
      ...
      borderColor: 'border-restaurants-200',
      iconColor: 'text-restaurants-600',
    ...
    },
    {
      ...
      borderColor: 'border-kids-200',
      iconColor: 'text-kids-600',
      btnClass: 'btn-kids',
    },
  ];
                ...
                >
                  <button
                    ...
                    className={`card w-full p-6 text-left transition-all duration-300 
                              ${theme.hoverBg} border-2 ${theme.borderColor} group`}
                  >
      ...
      <section className="px-4 py-12 sm:py-16 bg-white">
        <div className="max-w-4xl mx-auto">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="font-display text-2xl sm:text-3xl font-semibold text-center text-slate-900 mb-12"
          >
            {t('home.howItWorks')}
          </motion.h2>
              ...
              return (
                ...
                >
                  <div className="relative inline-flex mb-4">
                    ...
                    <span className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-slate-900 
